...
SPOOL C:\BD1\francisco_ricardo_L4Q1b_part4b.txt

CREATE TABLE customer(custid NUMBER,phone varchar2(10), 
custname VARCHAR2(50) CONSTRAINT customer_custname_NN NOT NULL,
CONSTRAINT customer_custid_PK PRIMARY KEY (custid));

CREATE TABLE supplier(supplierid NUMBER, 
suppliername VARCHAR2(50) CONSTRAINT supplier_suppliername_NN NOT NULL, 
...
CONSTRAINT orders_custid_FK FOREIGN KEY (custid)
REFERENCES customer(custid));

CREATE TABLE product(productid NUMBER, supplierid NUMBER,
description varchar2(50) CONSTRAINT product_description_NN NOT NULL, 
price NUMBER (10,2) CONSTRAINT product_price_CK CHECK (price >= 0), 
CONSTRAINT product_productid_PK PRIMARY KEY (productid),
CONSTRAINT product_supplierid_FK FOREIGN KEY (supplierid)
